    ...
    <div>
      ...
      <div className="border mb-4 p-3">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            <tr className="border-b"><td className="p-2">KYC schedule update</td><td className="p-2">2026-05-15</td><td className="p-2">Pending</td></tr>
            <tr className="border-b"><td className="p-2">V-CIP implementation</td><td className="p-2">2026-06-30</td><td className="p-2">In Progress</td></tr>
            <tr className="border-b"><td className="p-2">Quarterly reporting setup</td><td className="p-2">2026-07-01</td><td className="p-2">Not Started</td></tr>
            <tr className="border-b"><td className="p-2">Staff training</td><td className="p-2">2026-06-15</td><td className="p-2">Not Started</td></tr>
          </tbody>
        </table>
      </div>

      <div className="flex gap-2">
        <button className="border px-3 py-1 text-sm font-semibold bg-primary text-primary-foreground">Download PDF</button>
        <button className="border px-3 py-1 text-sm font-semibold bg-background" onClick={() => window.print()}>Print</button>
      </div>
    </div>
  );
}
